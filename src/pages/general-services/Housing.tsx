        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center space-x-reverse space-x-4 mb-4">
              ...
              <div>
                <h1 className="text-3xl lg:text-4xl font-bold">توفير السكن المناسب</h1>
                <p className="text-lg opacity-90 mt-1">سكن آمن ومريح قريب من جامعتك</p>
              </div>
            </div>
          </div>
        </div>
